...
document.addEventListener("DOMContentLoaded", function(e) {
    ...
    var l, t, e = $(".datatables-basic"),
        ...
        r = (e.length && (l = e.DataTable({
            ajax: "http://localhost:8000/assets/new-dashboard/" + "json/table-datatable.json",
            columns: [{
                data: ""
            }, {
                data: "id"
            ...
            columnDefs: [{
                ...
                render: function(e, t, a, s) {
                    var n = a.avatar,
                        l = a.full_name,
                        r = a.post;
                    return '<div class="d-flex justify-content-start align-items-center user-name"><div class="avatar-wrapper"><div class="avatar me-2">' + (n ? '<img src="' + "http://localhost:8000/assets/new-dashboard/" + "img/avatars/" + n + '" alt="Avatar" class="rounded-circle">' : '<span class="avatar-initial rounded-circle bg-label-' + ["success", "danger", "warning", "info", "primary", "secondary"][Math.floor(6 * Math.random())] + '">' + (n = (((n = (l = a.full_name).match(/\b\w/g) || []).shift() || "") + (n.pop() || "")).toUpperCase()) + "</span>") + '</div></div><div class="d-flex flex-column"><span class="emp_name text-truncate">' + l + '</span><small class="emp_post text-truncate text-muted">' + r + "</small></div></div>"
                }
            }, {
